...
**Author:** [Bhavesh](https://github.com/bhaveshamre) · **Repository:** [UPI-Without-Internet](https://github.com/bhaveshamre/UPI-Without-Internet)

A Spring Boot backend for **offline UPI-style payments routed through a Bluetooth-style mesh network**. You're in a basement with zero connectivity. You send your friend ₹500. Your phone encrypts the payment, broadcasts it to nearby phones, and the packet hops device-to-device until *some* phone walks outside, gets 4G, and silently uploads it to this backend. The backend decrypts, deduplicates, and settles.
...
> **Portfolio note:** This project demonstrates **mesh-routed deferred settlement** — not real-time NPCI UPI integration. The cryptography, idempotency, and settlement pipeline are production-shaped; the mesh and ledger are simulated for demo purposes.
...
```bash
git clone https://github.com/bhaveshamre/UPI-Without-Internet.git
...
**Bhavesh** — [GitHub @bhaveshamre](https://github.com/bhaveshamre)

Built as a personal project to explore offline payment routing, hybrid encryption, and exactly-once settlement under concurrent bridge uploads.
